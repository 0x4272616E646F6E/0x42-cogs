...
class FunctionCallingSettings(MixinMeta):
    ...
    async def toggle_search_function(self, ctx: commands.Context):
        ...
        from localaibot.functions.search.tool_call import SearchToolCall
    ...
    async def toggle_scrape_function(self, ctx: commands.Context):
        ...
        """
        from localaibot.functions.scrape.tool_call import ScrapeToolCall
    ...
    async def toggle_weather_function(self, ctx: commands.Context):
        ...
        """
        from localaibot.functions.weather.tool_call import (
            IsDaytimeToolCall,
    ...
    async def toggle_ignore_function(self, ctx: commands.Context):
        ...
        """
        from localaibot.functions.noresponse.tool_call import NoResponseToolCall
    ...
    async def toggle_wolfram_alpha_function(self, ctx: commands.Context):
        ...
        from localaibot.functions.wolframalpha.tool_call import WolframAlphaFunctionCall
